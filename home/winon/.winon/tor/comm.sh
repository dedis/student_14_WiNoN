...
ifconfig lo:1 10.2.0.1 netmask 255.255.255.255
...
iptables -t nat -A PREROUTING -i eth1 ! -d 10.0.1.0/24 -p tcp -j DNAT --to-destination 10.2.0.1:8082
iptables -t nat -A PREROUTING -i eth1 -p udp --dport 53 -j DNAT --to-destination 10.2.0.1
